...
is invariant.
    ...
    \item WIP
    \item WIP
    %\item Computamos el término $10^{6-\lfloor\log p\rfloor}$. Tenemos: $$ (6 -
    %    \lfloor\log p\rfloor) \in [6 - 20, 6 -(-18)] =[-14, 24] $$ Luego
    %    cláramente $10^{24}$ cabe en \texttt{SignedDecimal256}. Igualmente, tanto
    %    $-14$ como $24$ caben en \texttt{i32} de sobra.
\end{enumerate}
